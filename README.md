...
- [YC role index](datasets/yc-role-index.md) — role-based discovery map regenerated by the always-on agent
- [YC founder index](datasets/yc-founders-index.md) — public founders from YC's explicitly flagged top-company profiles
...
ycombinator role-index
ycombinator founder-index       # refresh public founder profiles
